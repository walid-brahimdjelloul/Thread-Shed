...
## iterate through daily_transactions split the string around |
daily_transactions_split = [i.split('|') for i in daily_transactions]
## print(daily_transactions_split)

## terate through daily_transactions_split and for each transaction iterate through the different data points and strip off any whitespace
transactions_clean = []
for daily_tras in daily_transactions_split:
  daily_clean = []
  for cleaner in daily_tras:
    daily_clean.append(cleaner.strip())
